...
// import { CommentsRow } from 'semantic-ui-react';
...
//     return (
//       <>
//       <CommentsRow style={{marginBottom:20}}>
//         <CommentsRow.Avatar
...
//           style={imgStyle} /> 
//         <CommentsRow.Content>
//           <CommentsRow.Author onClick={this.handleUserProfileShow}  as='a'>{this.props.user.last_name+this.props.user.first_name}</CommentsRow.Author>

//         {!this.state.editForm ?
//         <>
//           <CommentsRow.Metadata>
//             <div>{this.DateFormat(this.props.comment.modified_date)}</div>
//           </CommentsRow.Metadata>
//           <CommentsRow.Text>{this.state.content}</CommentsRow.Text>
                
//             {this.props.comment.user_login_id === $.cookie('login_id')
//             ?
//               <>
//               <CommentsRow.Actions style={{ paddingLeft:"15px"}}>
//                 <CommentsRow.Action onClick={this.editComment}> 수정 </CommentsRow.Action>
//                 <CommentsRow.Action onClick={this.deleteComment.bind(this.props.comment._id)}> 삭제 </CommentsRow.Action>
//               </CommentsRow.Actions>
//               </>
//             : <><CommentsRow.Actions/></>
//             }
...
//   getCommentIndex = () => {
//     const send_param ={board_id: this.props.post_id};
//     axios
//       .get(`/comments`, {
//         params:{
//           boardId: send_param.board_id,
//           page: pageNum
//         }
//       })
//       .then(response => {
